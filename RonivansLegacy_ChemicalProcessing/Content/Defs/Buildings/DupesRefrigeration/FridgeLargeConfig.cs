...
{
    class FridgeLargeConfig : IBuildingConfig, IHasConfigurableStorageCapacity, IHasConfigurableWattage
	{
		...
		public static string ID = "AIO_FridgeLarge";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 2, 3, "advanced_refrigerator_kanim", 30, 30f, TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER5, MATERIALS.REFINED_METALS, 800f, BuildLocationRule.OnFloor, TUNING.BUILDINGS.DECOR.BONUS.TIER1, noise);
			...
			SoundEventVolumeCache.instance.AddVolume("advanced_refrigerator_kanim", "Refrigerator_open", NOISE_POLLUTION.NOISY.TIER1);
			SoundEventVolumeCache.instance.AddVolume("advanced_refrigerator_kanim", "Refrigerator_close", NOISE_POLLUTION.NOISY.TIER1);
			SoundUtils.CopySoundsToAnim("advanced_refrigerator_kanim", "fridge_kanim");
			return buildingDef;
		}
